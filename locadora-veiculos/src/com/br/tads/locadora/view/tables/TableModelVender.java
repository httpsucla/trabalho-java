 ...
 * @author paula
 */
public class TableModelVender extends AbstractTableModel{
    private List<Automovel> veiculos;
    private String[] columns = {"Placa", "Marca", "Modelo", "Ano", "Preço Venda"};
    
    public TableModelVender() {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 4:
                return veiculo.getValorParaVenda();
            default:
                return null;
        }
    }
